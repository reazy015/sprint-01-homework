...
const blogs_command_repository_1 = require("../repositories/command/blogs-command-repository");
const comments_command_repository_1 = require("../repositories/command/comments-command-repository");
const posts_command_repository_1 = require("../repositories/command/posts-command-repository");
